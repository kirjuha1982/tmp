<div class="row" data-plugin="matchHeight" data-by-row="true">
                ...
                <ul class="list-group list-group-full list-group-dividered m-b-0">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <a class="avatar avatar-lg" href="javascript:void(0)">
                                    <img class="img-responsive" src="/libs/global/portraits/1.jpg" alt="...">
                                </a>
                            </div>
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="media-left">
                                <a class="avatar avatar-lg" href="javascript:void(0)">
                                    <img class="img-responsive" src="/libs/global/portraits/2.jpg" alt="...">
                                </a>
                            </div>
                            <div class="media-body">
                    ...
                    <li class="list-group-item">
                        <div class="media">
                            <div class="media-left">
                                <a class="avatar avatar-lg" href="javascript:void(0)">
                                    <img class="img-responsive" src="/libs/global/portraits/3.jpg" alt="...">
                                </a>
                            </div>
                            <div class="media-body">
                    ...
                    <div class="chat chat-left">
                        <div class="chat-avatar">
                            <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="">
                                <img src="/libs/global/portraits/5.jpg" alt="Edward Fletcher">
                            </a>
                        </div>
                        <div class="chat-body">
                    ...
                    <div class="chat">
                        <div class="chat-avatar">
                            <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="">
                                <img src="/libs/global/portraits/4.jpg" alt="June Lane">
                            </a>
                        </div>
                        <div class="chat-body">
    ...
    <div class="col-xl-4 col-lg-6">
        ...
        <div class="card card-shadow">
            ...
            <div class="card-block p-x-30 p-y-20" style="height:calc(100% - 250px);">
